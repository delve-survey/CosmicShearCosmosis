...
matter_powspec = section_names.matter_power_nl #I had to change this to be _nl instead of _lin else it doesn't work for us
...
def execute(block, config):
    ...
    sigma8_input = block[cosmo, 'sigma_8_input']
