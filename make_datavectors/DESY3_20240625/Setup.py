...
OUTFILE = "baseline_June25th2024_DESY3.fits"
...
FILES = {'Cov' : '/home/dhayaa/DECADE/CosmicShearCosmosis/covariance/analytic/June25th2024_DESY3/FinalCov.npy',
        }
...
X = np.loadtxt('/home/dhayaa/DECADE/CosmicShearCosmosis/covariance/analytic/June25th2024_DESY3/DES_Y3.txt')
z_grid = X[X[:, 0] == 0, 1]

n_of_z = np.zeros([len(z_grid), 4])
for i in range(4): n_of_z[:, i] = X[X[:, 0] == i, 2]
...
[DEFAULT]
2PT_FILE = baseline_June25th2024_DESY3.fits
